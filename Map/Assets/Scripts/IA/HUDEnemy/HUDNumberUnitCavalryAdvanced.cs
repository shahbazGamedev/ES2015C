...
/// </summary>
public class HUDNumberUnitCavalryAdvanced : MonoBehaviour
{
    /// <summary>
    ...
    public int numberCavalryAdvanced2;
    ...
    void Start()
    {
        ...
        numberCavalryAdvanced2 = (int) aux.numberCavalryAdvanced;
    ...
    void Update()
    {
        ...
        textComponent.text = "x" + (numberCavalryAdvanced2).ToString();
