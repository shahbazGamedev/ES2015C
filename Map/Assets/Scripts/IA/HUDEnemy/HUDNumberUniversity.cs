...
/// </summary>
public class HUDNumberUniversity : MonoBehaviour
{
    /// <summary>
    ...
    void Start()
    {
        ...
        numberUniversity2 = (int) aux.numberUniversity;
    ...
    void Update()
    {
        ...
        textComponent.text = "x" + (numberUniversity2).ToString();
