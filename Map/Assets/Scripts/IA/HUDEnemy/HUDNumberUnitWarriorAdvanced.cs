...
/// </summary>
public class HUDNumberUnitWarriorAdvanced : MonoBehaviour
{
    /// <summary>
    ...
    public int numberWarriorAdvanced2;
    ...
    void Start()
    {
        ...
        numberWarriorAdvanced2 = (int) aux.numberWarriorAdvanced;
    ...
    void Update()
    {
        ...
        textComponent.text = "x" + (numberWarriorAdvanced2).ToString();
