...
/// </summary>
public class HUDNumberUnitArcherAdvanced : MonoBehaviour
{
    /// <summary>
    ...
    public int numberArcherAdvanced2;
    ...
    void Start()
    {
        ...
        numberArcherAdvanced2 = (int) aux.numberArcherAdvanced;
    ...
    void Update()
    {
        ...
        textComponent.text = "x" + (numberArcherAdvanced2).ToString();
