...
/// </summary>
public class HUDNumberArmyBuilding : MonoBehaviour
{
    /// <summary>
    ...
    public int numberArmyBuilidngs2;
    ...
    void Start()
    {
        ...
        numberArmyBuilidngs2 = (int) aux.numberArmyBuilidngs;
    ...
    void Update()
    {
        ...
        textComponent.text = "x" + (numberArmyBuilidngs2).ToString();
